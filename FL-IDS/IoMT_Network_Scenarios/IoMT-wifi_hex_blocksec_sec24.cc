...
NodeContainer wifiApNode, wifiNodes, hexoskinNodes;
...
void EnhancedObserveFlowStats(NodeMonitor& monitor,
    ...
    monitor.RecordTrainingSample(dm, false);
...
int main(int argc, char *argv[]) {
    ...
    std::string networkType = "normal";
    uint32_t seedValue = 1;
    std::string flowOutputPath = "flowmonitor-stats_chapter6_flids_normal.xml";

    CommandLine cmd;
    cmd.AddValue("attackType", "Type of attack: none / normal", networkType);
