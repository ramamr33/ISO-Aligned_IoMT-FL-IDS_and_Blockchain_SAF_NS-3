...
public:
    ...
    void UpdateEnergyConsumption() 
    {
       ...
       std::ofstream log("bluetooth_energy_log_hexo.csv", std::ios::app);
...
int main(int argc, char *argv[]) {
    ...
    std::string flowOutputPath = "flowmonitor-stats_chapter6_integrated_hexo.xml";
    ...
    g_assessmentLogger = new ComprehensiveAssessmentLogger("comprehensive_risk_assessment_chapter6_hexo.csv");
    ...
    phy.EnablePcap("wifi-ap_chapter6_hexo", apDevice);
    phy.EnablePcap("baxter_chapter6_hexo", staDevices.Get(0));
    p2p.EnablePcap("hexoskin_chapter6_hexo", p2pDevices);
    phy.EnablePcap("hexoskin_phone_chapter6_hexo", staDevices.Get(1));
    phy.EnablePcap("mitm_chapter6_hexo", mitmDevice);

    AnimationInterface anim("network-anim_chapter6_hexo.xml");
    anim.SetMaxPktsPerTraceFile(2000000);
    anim.SetMobilityPollInterval(Seconds(1));
    anim.EnablePacketMetadata(true);
    
    energyLogFile.open("energy_log_chapter6_hexo.csv");
...
Simulator::Run();
    ...
    std::ofstream outfile("arrival_times_qos_hexo.csv");
